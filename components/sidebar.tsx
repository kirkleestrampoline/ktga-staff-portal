...
export default function Sidebar({tab,setTab,name,role,clubName,onSignOut,mobileOpen,onClose}:{tab:Tab;setTab:(t:Tab)=>void;name:string;role:string;clubName?:string;onSignOut:()=>void;mobileOpen:boolean;onClose:()=>void}){
