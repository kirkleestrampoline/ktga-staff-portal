  ...
  return <main className="v3LoginPage">
    ...
    <section className="v3LoginFormPanel">
      ...
      <form className="v3LoginCard" onSubmit={recovering?requestRecovery:signIn}>
        ...
        <div className="v3Field"><label>Club</label><div className="v3InputShell"><span className="v3InputIcon"><ClubGlyph/></span><input type="text" autoCapitalize="none" autoCorrect="off" autoComplete="organization" placeholder="e.g. greenhead" value={clubCode} onChange={e=>setClubCode(e.target.value.toLowerCase().replace(/\s+/g,""))}/></div></div>
        <div className="v3Field"><label>{recovering?"Username":"Username or email"}</label><div className="v3InputShell"><span className="v3InputIcon"><MailGlyph/></span><input type="text" autoCapitalize="none" autoCorrect="off" autoComplete="username" placeholder={recovering?"e.g. gabby":"e.g. gabby or your existing email"} value={identifier} onChange={e=>setIdentifier(e.target.value)} required/></div></div>
