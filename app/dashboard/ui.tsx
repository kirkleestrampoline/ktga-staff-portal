...
export default function Dashboard({initialProfile}:{initialProfile:Profile}){
  ...
  return <div className="portal">
    ...
    <div className="mainWrap">
      <header className="topbar"><div className="row"><div className="v3HeaderLogo"><AvLogo size={31}/></div><div className="topTitle">AV Gymnastics</div></div><div className="topActions"><span className="versionBadge">v4.3.6</span><span className="muted desktopEmail" style={{fontSize:12}}>{initialProfile.email}</span></div></header>
      <main className="main">
