...
export default function Dashboard({initialProfile}:{initialProfile:Profile}){
  ...
  async function saveClass(){
    ...
    setSaving(false);setClassModal(null);flash("Class saved without creating duplicate schedule slots.");await loadSchedule();
  }
  ...
  return <div className="portal">
    ...
    <div className="mainWrap">
      <header className="topbar"><div className="row"><div className="topBrandMark">AV</div><div className="topTitle">AV Gymnastics Solutions</div></div><div className="topActions"><span className="versionBadge">v2.0.3</span><span className="muted desktopEmail" style={{fontSize:12}}>{initialProfile.email}</span></div></header>
      <main className="main">
